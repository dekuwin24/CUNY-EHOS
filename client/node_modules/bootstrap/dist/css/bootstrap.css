...
.btn-primary:focus, .btn-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(125, 79, 173, 0.5);
}
...
.badge-primary[href]:hover, .badge-primary[href]:focus {
  color: #fff;
  text-decoration: none;
  background-color: rgb(125, 79, 173);
}
...
.badge-success {
  color: #fff;
  background-color: #28a745;
  background-color: linear-gradient(to right, rgba(80, 204, 127, 0.9), rgba(245, 209, 0, 0.75));
}
